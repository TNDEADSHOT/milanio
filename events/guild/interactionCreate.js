			...
			if (interaction.isCommand()) {
                    ...
                    if (command.premium && premiumServer && !premiumServer.isPremium) {
                        return interaction.reply({
                            embeds: [new MessageEmbed()
                                ...
                                Join **[CoreWorks Development](${process.env.SUPPORT})** And **Open a Ticket!**`)
                                .setColor(ee.wrongcolor)
                            ],
                            ephemeral: true
                        })
                ...
                commandLogsChannel.send({
                    embeds: [new MessageEmbed()
                        ...
                        .setTitle(`<a:YellowArrow:904258979432132640> Slash Command`)
                        .addField("**<a:YellowArrow:904258979432132640> Author**", `\`\`\`${interaction.user.tag}\`\`\``)
